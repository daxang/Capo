...
import 'package:capo/modules/wallet/restore/from_keystore//viewmodel/view_model.dart';
import 'package:capo/provider/provider_widget.dart';
import 'package:easy_localization/public.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class FromKeystoreView extends StatefulWidget {
  FromKeystoreView({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _FromKeystoreState();
  }
}

class _FromKeystoreState extends State<FromKeystoreView>
        ...
        builder: (_, viewModel, __) => ListView(
              children: <Widget>[
                TextField(
                  ...
                  onChanged: (out) => viewModel.keystoreKeySubject.add(out),
                  decoration: InputDecoration(
                      hintText:
                          tr("wallet.restore.from_keystore.keystore_hint_text"),
                ...
                CupertinoButton(
                  ...
                  child: Text(
                    tr("wallet.restore.from_keystore.btnTitle"),
