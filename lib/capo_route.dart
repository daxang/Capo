...
import 'package:capo/modules/settings/settings_modules/dapp_settings/dapp_settings_page.dart';
...
import 'modules/settings/settings_modules/about/privacy_security/privacy_security_page.dart';
...
RouteResult getRouteResult({String pageUrl}) {
  ...
  switch (routeUrl) {
    ...
    case "capo://icapo.app/settings/about/privacy_security":
      return RouteResult(
        widget: PrivacySecurityPage(),
      );
    ...
    case "capo://icapo.app/settings/dApp_settings":
      return RouteResult(
        widget: DAppSettings(),
      );
    ...
    case "capo://icapo.app/dappbrowser":
      return RouteResult(
        widget: DAppBrowserPage(),
      );
